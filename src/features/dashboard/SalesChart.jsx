...
const StyledSalesChart = styled(DashboardBox)`
  /* Meaning that it will occupy the entire width */
  grid-column: 1 / -1;
...
function SalesChart({ bookings, numDays }) {
  ...
  // This is used to get all dates from current date to some date in the past which will be specified in the filter
  const allDates = eachDayOfInterval({
    start: subDays(new Date(), numDays - 1),
    end: new Date(),
  });

  // Creatinf our own data similar to 'fakeData'
